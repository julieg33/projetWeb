            ...
            <form>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <textarea class="form-control" id="description" rows="3">[Description de l'offre]</textarea>
                    </div>
                    <div class="form-group col-md-6 text-center">
                        <button type="button" class="btn btn-dark mt-5 w-25 h-50" id="valider">Modifier</button>
                    </div>
