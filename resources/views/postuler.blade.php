...
@section('css')
    <link rel="stylesheet" type = "text/css" href ="{{url('css/postuler.css')}}">
@endsection
...
<div class="card w-75 text-center  mx-auto mt-3" id="content">
    ...
    <div class="card-body">
        ...
        <div class="row mt-3">
            ...
            <div class="col-11"> <textarea class="form-control" id="description" rows="3"></textarea></div>
        </div>
        <div class="row mt-3" >
        ...
        <button type="button" class="btn btn-dark center-block mt-3 w-25">Valider</button>
    </div>
</div>
